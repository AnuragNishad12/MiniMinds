...
class EasternWolf extends StatefulWidget {
  const EasternWolf({super.key});

  @override
  State<EasternWolf> createState() => _EasternWolfState();
}

class _EasternWolfState extends State<EasternWolf> {
  ...
  Future<List<String>> _getImageUrls() async {
    ListResult result = await FirebaseStorage.instance
        .ref()
        .child("/Animals/Wolf/Eastern Wolf")
        .listAll();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Eastern Wolf", style: GoogleFonts.luckiestGuy(
          textStyle: TextStyle(
            color: Colors.white,
            fontSize: 24,
