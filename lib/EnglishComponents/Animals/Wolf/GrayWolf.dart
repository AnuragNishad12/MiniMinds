...
class GrayWolf extends StatefulWidget {
  const GrayWolf({super.key});

  @override
  State<GrayWolf> createState() => _GrayWolfState();
}

class _GrayWolfState extends State<GrayWolf> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Gray Wolf", style: GoogleFonts.luckiestGuy(
          textStyle: TextStyle(
            color: Colors.white,
            fontSize: 24,
