...
class RedWolf extends StatefulWidget {
  const RedWolf({super.key});

  @override
  State<RedWolf> createState() => _RedWolfState();
}

class _RedWolfState extends State<RedWolf> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Red Wolf", style: GoogleFonts.luckiestGuy(
          textStyle: TextStyle(
            color: Colors.white,
            fontSize: 24,
