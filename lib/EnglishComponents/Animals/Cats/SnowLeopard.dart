...
class SnowLeopard extends StatefulWidget {
  const SnowLeopard({super.key});

  @override
  State<SnowLeopard> createState() => _SnowLeopardState();
}

class _SnowLeopardState extends State<SnowLeopard> {
  ...
  Future<List<String>> _getImageUrls() async {
    ListResult result = await FirebaseStorage.instance
        .ref()
        .child('Animals/Cats/Snow Leopard')
        .listAll();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Snow Leopard", style: GoogleFonts.luckiestGuy(
          textStyle: TextStyle(
            color: Colors.white,
            fontSize: 24,
