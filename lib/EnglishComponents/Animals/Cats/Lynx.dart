...
class Lynx extends StatefulWidget {
  const Lynx({super.key});

  @override
  State<Lynx> createState() => _LynxState();
}

class _LynxState extends State<Lynx> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Lynx", style: GoogleFonts.luckiestGuy(
          textStyle: TextStyle(
            color: Colors.white,
            fontSize: 24,
