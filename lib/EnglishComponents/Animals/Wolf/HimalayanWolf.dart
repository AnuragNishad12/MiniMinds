...
class HimalayanWolf extends StatefulWidget {
  const HimalayanWolf({super.key});

  @override
  State<HimalayanWolf> createState() => _HimalayanWolfState();
}

class _HimalayanWolfState extends State<HimalayanWolf> {
  ...
  Future<List<String>> _getImageUrls() async {
    ListResult result = await FirebaseStorage.instance
        .ref()
        .child("/Animals/Wolf/Himalayan Wolf")
        .listAll();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Himalayan Wolf", style: GoogleFonts.luckiestGuy(
          textStyle: TextStyle(
            color: Colors.white,
            fontSize: 24,
