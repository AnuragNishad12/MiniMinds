...
class ArcticWolf extends StatefulWidget {
  const ArcticWolf({super.key});

  @override
  State<ArcticWolf> createState() => _ArcticWolfState();
}

class _ArcticWolfState extends State<ArcticWolf> {
  ...
  Future<List<String>> _getImageUrls() async {
    ListResult result = await FirebaseStorage.instance
        .ref()
        .child("/Animals/Wolf/Arctic Wolf")
        .listAll();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text("Arctic Wolf", style: GoogleFonts.luckiestGuy(
          textStyle: TextStyle(
            color: Colors.white,
            fontSize: 24,
